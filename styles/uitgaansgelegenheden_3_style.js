...
var style_uitgaansgelegenheden_3 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var labelText = "";
    size = 0;
    var labelFont = "52.0px \'Arial Black\', sans-serif";
    ...
    var offsetY = 3;
    var placement = 'point';
    if (feature.get("Title") !== null && resolution > 1 && resolution < 7) {
